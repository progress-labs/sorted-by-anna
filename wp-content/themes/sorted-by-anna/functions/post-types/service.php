...
function service_init() {
	register_post_type( 'service', array(
		'labels'            => array(
			'name'                => __( 'Service', 'YOUR-TEXTDOMAIN' ),
			'singular_name'       => __( 'Service', 'YOUR-TEXTDOMAIN' ),
			'all_items'           => __( 'All Service Items', 'YOUR-TEXTDOMAIN' ),
			'new_item'            => __( 'New Service Items', 'YOUR-TEXTDOMAIN' ),
			'add_new'             => __( 'Add New', 'YOUR-TEXTDOMAIN' ),
			'add_new_item'        => __( 'Add New Service Item', 'YOUR-TEXTDOMAIN' ),
			'edit_item'           => __( 'Edit Service Item', 'YOUR-TEXTDOMAIN' ),
			'view_item'           => __( 'View Service Item', 'YOUR-TEXTDOMAIN' ),
			'search_items'        => __( 'Search Service Items', 'YOUR-TEXTDOMAIN' ),
			'not_found'           => __( 'No Service Items found', 'YOUR-TEXTDOMAIN' ),
			'not_found_in_trash'  => __( 'No Service Items found in trash', 'YOUR-TEXTDOMAIN' ),
			'parent_item_colon'   => __( 'Parent Service', 'YOUR-TEXTDOMAIN' ),
			'menu_name'           => __( 'Service', 'YOUR-TEXTDOMAIN' ),
		),
		'public'            => true,
		'hierarchical'      => false,
		'show_ui'           => true,
