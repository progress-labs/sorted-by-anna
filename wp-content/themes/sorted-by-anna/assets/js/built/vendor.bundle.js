...
/******/ 			script.async = true;
/******/
/******/ 			script.src = __webpack_require__.p + "" + {"0":"717ac320e8b9865af45d"}[chunkId] + ".js";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	!function (e) {
	  function t() {
	    ...
	    if (e.detectSwipe.preventDefault && n.preventDefault(), c) {
	      var i,
	          ...
	          u = n.touches[0].pageY,
	          r = o - s,
	          a = h - u;Math.abs(r) >= e.detectSwipe.threshold ? i = r > 0 ? "left" : "right" : Math.abs(a) >= e.detectSwipe.threshold && (i = a > 0 ? "down" : "up"), i && (t.call(this), e(this).trigger("swipe", i).trigger("swipe" + i));
	    }
	  }function i(e) {
	  ...
	  }e.detectSwipe = { version: "2.1.1", enabled: "ontouchstart" in document.documentElement, preventDefault: !0, threshold: 20 };var o,
	      h,
	      c = !1;e.event.special.swipe = { setup: s }, e.each(["left", "up", "down", "right"], function () {
